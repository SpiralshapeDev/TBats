...
{
	public class ChlorophyteBat : ModItem
	{
		public override void SetDefaults()
		{
			Item.damage = ModContent.GetInstance<ServerConfig>().ChlorophyteBatDamage;
			...
			Item.shoot = ModContent.ProjectileType<ChlorophyteBatProjectile>(); // The sword as a projectile
		}
