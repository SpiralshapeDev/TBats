...
namespace Tbats.Content.Items
{
	public class ShroomiteBat : ModItem
	{
        ...
        public override void SetDefaults()
		{
			...
			Item.value = Item.sellPrice(gold:13,silver:33);
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.ShroomiteBar, 40);
