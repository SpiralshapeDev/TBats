...
namespace Tbats.Content.Items
{
	public class TitaniumBat : ModItem
	{
        ...
        public override void SetDefaults()
		{
			...
			Item.value = Item.sellPrice(gold:9,silver:6,copper:60);
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.TitaniumBar, 40);
